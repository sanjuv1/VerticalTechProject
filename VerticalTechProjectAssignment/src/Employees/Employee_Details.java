...
class Employee_Details implements ActionListener{
    JFrame f;
    ...
    Employee_Details(String e_id){
        try{
            conn con = new conn();
            String str = "select * from employeedetails where EmpID = '"+e_id+"'";
    ...
    public static void main(String[] args){
        new Employee_Details("Print Data");
    }
